...
export const FINANCE_CATEGORIES: Record<FinanceType, FinanceCategory[]> = {
  income: [
    ...
    { key: 'msig-agent-commissions', label: 'MSIG Agent Commissions', icon: '👨🏻‍💼', active: false },
    { key: 'vis-perfume', label: 'ViS Perfume - Business Investments', icon: '💼', active: false },
  ...
  saving: [
    ...
    { key: 'nvidia-rtx-3080', label: 'NVIDIA RTX 3080', icon: '🖥️', active: true },
  ],
  investment: [
