...
type DeviceTab = 'log' | 'iphone';

// Log dulu (pengeluarannya), lalu paket HP.
//
...
//
// Sub-tab Stuff 📦 DIHAPUS TOTAL atas permintaan — beda dari iPad di atas:
// kodenya, dokumen Firestore-nya (users/{uid}/app/stuff), badge & remindernya
// dibuang semua, tidak ada sisa yang disembunyikan.
