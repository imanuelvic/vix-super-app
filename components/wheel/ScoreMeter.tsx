...
/** Score Wheel of Life selalu 1–10. */
const MAX_SCORE = 10;

/**
 * Meteran score area fokus: SATU bar yang memuat dua angka sekaligus —
 * isian mint pucat sampai TARGET, lalu isian warna nada score sampai posisi
